...
$sql = "SELECT * FROM game_editions WHERE edition_id='$edition_id' LIMIT 1";
...
<html lang="en">
    <head>
        <title><?php echo "$edition"; ?> Profile</title>
        <meta charset="UTF-8">
        ...
        <div class="container" id="profileContainer">
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    ...
                    <div class="inlineTitle"><h3>User Reviews:</h3><a type="button" href="userreviews.php?game_id=<?php echo "$game_id"; ?>&edition=<?php echo "$edition_id"; ?>" id="viewall2" class="btn btn-lg btnColor">VIEW ALL &#8658;</a></div>
            ...
            if(isset($_SESSION["user_id"])){
                echo "                    
                    ...
                    <div class='inlineTitle gametitle'><h3>Upcoming Events Playing <strong>$edition:</strong></h3><a type='button' href='gameevents.php?game=$game_id&edition=$edition_id' id='viewall3' class='btn btn-lg btnColor gameeventbtn'>VIEW ALL &#8658;</a></div>
                    <h3 class='phonegametitle'>Upcoming Events Playing <strong>$edition:</strong></h3>
                    <a type='button' href='gameevents.php?game=$game_id&edition=$edition_id' id='viewall3' class='btn btn-lg btnColor phonegameeventbtn'>VIEW ALL &#8658;</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="game" name="game" placeholder="<?php if(!empty($edition)){
                                                    echo $edition;
                                                    }else{
                                                    echo "Name";
                                                    } ?>" maxlength="50">
...
<!--      Here Maps API Java-->
      ...
      <script src="https://js.api.here.com/v3/3.1/mapsjs-mapevents.js"></script>
        ...
        <script src="js/editionpage.js"></script>
