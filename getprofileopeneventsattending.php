...
$sql = "SELECT * FROM open_event_attendance LEFT JOIN userevents ON open_event_attendance.event_id = userevents.event_id WHERE open_event_attendance.user_id='$profile_id' AND regular='N' AND (date < now()) ORDER BY date ASC";
