        ...
        <div class="jumbotron" id="myContainer">
                ...
                <div class="container" id="eventAttendingContainer">
                    ...
                    <div class="eventContainerTitles">
                        <p class="eventATitle">Limited Events I'm Attending:</p>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
...
<!--                            Send Message form-->
                            ...
                            <div class="form-group">
                                <label>
                                    Request to Book Seat for Event?
                                    <input type="checkbox" name="messageBookSeat" id="messageBookSeat" value="1">        
                                </label>
                            </div>
                        </div>
...
<!--        Custom JS        -->
        ...
        <script src="js/attendinglevents.js"></script>
        <script>
            $(function(){
