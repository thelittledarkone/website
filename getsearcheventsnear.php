...
$sql1 .= " AND user_id != '$user_id' AND event_name LIKE '%$data%' ORDER BY date_added DESC";
...
//                $eventpostcode = $row1['postal_code'];
        ...
        <div class='individualEvent'>
            <div class='row mainContent'>
                ...
                <div class='col-sm-8 detailsContainer nearDetailsContainer'>
                    ...
                    if($eventType == 'o'){
                        echo "<tr>
                                <td class='col-xs-3'>This is an Open Event!</td>
                                <td class='col-xs-9'>People Attending: $attendees</td>
                            </tr>";
                    }else{
                        echo "<tr>
                                <td class='col-xs-3'>This is a Limited Event!</td>
                                <td class='col-xs-9'>Seats Left: $eventseats</td>
                            </tr>";
                    }
