...
$sql = "SELECT * FROM event_forum_topics WHERE topic_id='$topID'";
...
else
{
    ...
    else
    {
        ...
        $sql = "SELECT * FROM event_forum_posts LEFT JOIN users ON event_forum_posts.post_by = users.user_id WHERE event_forum_posts.post_topic = '$topID' ORDER BY event_forum_posts.post_date DESC";
        $result = mysqli_query($link, $sql);
