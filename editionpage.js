...
//Calendar
$('input[name="date"], input[name="dateE"]').datepicker({
    numberOfMonths: 1,
    showAnim: "fadeIn",
    dateFormat: "D d M, yy",
    maxDate: "+12M"
...
//        Ajax call successful: show error or success message
        success: function(returnedData){
            ...
            unlike(); like(); getGameEvents(); getGameReviews();
        },
