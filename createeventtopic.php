...
$sql = "INSERT INTO event_forum_topics (`topic_subject`, `topic_date`, `topic_cat`, `topic_by`, `event_id`) VALUES ('$topicname', '$time', '$topcat', '$user_id', '$event_id')";
...
if(!$result){
    ...
    $sql = "INSERT INTO event_forum_posts (`post_content`, `post_date`, `post_topic`, `event_id`, `post_by`) VALUES ('$topdes', '$time', '$topicid', '$event_id', '$user_id')";
    $result = mysqli_query($link, $sql);
    if(!$result){
