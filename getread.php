...
$sql = "SELECT * FROM usermessages WHERE message_to='$user_id' AND read_status='1' AND (message_type='q' OR message_type='o' OR message_type='z') ORDER BY message_date DESC";
