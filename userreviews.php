...
<html lang="en">
    <head>
        <title>User Reviews - <?php echo "$game_name"; ?></title>
        <meta charset="UTF-8">
...
<!--        Main Content-->
        <div class="jumbotron" id="myContainer">
            <div class="container" id="nearEventContainer">
                <p class="gameeventTitle"><?php echo "$game_name"; ?></p>
                <div id="alert" class="alert alert-danger collapse">
                    <a class="close" data-dismiss="alert">&times;</a>
                    <p id="alertContentNear"></p>
                </div>
                <div class="eventContainerTitles">
                    <p class="reviewTitle">Reviews of <?php echo "$game_name"; ?>:</p>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div id="gameReviews" class="events"></div>
                    </div>
                </div>
                <form class="radiusForm">
                        <label for="radius" id="radiusLabel" style="color:slategrey;">Items Shown:</label>
                        ...
                        <button class="btn btn-sm btnColor" id="radiusBtn" type="button">Go</button>
                    </form>
            </div>
        </div>
