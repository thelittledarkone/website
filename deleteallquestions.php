...
$sql = "SELECT * FROM usermessages WHERE message_to='$user_id' AND message_type='$type' AND saved_status='0'";
...
$sql2 = "DELETE FROM usermessages WHERE message_to='$user_id' AND message_type='$type')";
