...
<html lang="en">
    <head>
        <title>thelittledarkone - Search</title>
        <meta charset="UTF-8">
...
<!--        Main Content-->
        <div class="container" id="profileContainer">
            <h3>Users Matching "<?php echo "$data"; ?>":</h3>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div id="profileResults" class="row searchpagemain"></div>
                </div>
            </div>
            <h3>Games/Sets Matching "<?php echo "$data"; ?>":</h3>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div id="gameResults" class="searchpagemain"></div> 
                </div>
            </div>
            <h3>Products Matching "<?php echo "$data"; ?>":</h3>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div id="productResults" class="searchpagemain"></div> 
                </div>
            </div>
            <?php
            if(isset($_SESSION["user_id"])){
                echo "<div class='divider' style='height:50px;'></div>
                <div class='row'>
                    <div class='col-md-offset-1 col-md-11'>
                        <form class='radiusForm'>
                            ...
                            <button class='btn btn-sm btnColor' id='radiusBtn' type='button'>Search</button>
                        </form>
                    </div>
                </div>
            ...
            <h3>Nearby Events Matching $data:</h3>
                    <div id='eventResults' class='searchpagemain'></div>";;
            }else{
        ...
        <?php
            if(!(isset($_SESSION["user_id"]))){
                echo "
                <div class='signuplower'>
                    <button type='button' class='btn btn-lg btnColor btnSignup' data-target='#signupModal' data-toggle='modal'>Sign Up, It's Free!</button>
                </div>
                ";
                }
            ?>
