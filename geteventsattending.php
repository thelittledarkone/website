...
if($_SESSION['uri'] == "/attendinglevents.php"){
    $sql = "SELECT * FROM userevents WHERE (player1_id='$user_id' OR player2_id='$user_id' OR player3_id='$user_id' OR player4_id='$user_id' OR player5_id='$user_id' OR player6_id='$user_id' OR player7_id='$user_id' OR player8_id='$user_id') AND ((regular='N' AND (date < now())) OR regular='Y') ORDER BY date_added DESC";
}else{
    $sql = "SELECT * FROM userevents WHERE (player1_id='$user_id' OR player2_id='$user_id' OR player3_id='$user_id' OR player4_id='$user_id' OR player5_id='$user_id' OR player6_id='$user_id' OR player7_id='$user_id' OR player8_id='$user_id') AND ((regular='N' AND (date < now())) OR regular='Y') ORDER BY date_added DESC LIMIT 5";
}
            ...
            <div class='row eventContainer'>
                ...
                <div class='col-sm-2 priceContainer'>
                    <div class='priceStats'>
                        <div class='perSeat'>Limited</div>
                                        <div>Event with</div>
                        <div class='seatDetails'>$seats seats left!</div>
                    </div>
                    <div class='priceBtns'>
