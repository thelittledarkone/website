...
$sql = "SELECT * FROM usermessages WHERE message_from='$user_id' AND saved_status='0' AND (message_type='q' OR message_type='o' OR message_type='z'))";
...
$sql2 = "DELETE FROM usermessages WHERE message_from='$user_id' AND (message_type='q' OR message_type='o')";
