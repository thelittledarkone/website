...
if($_SESSION['uri'] == "/eventsmanager.php"){
    $sql = "SELECT * FROM userevents WHERE user_id='$user_id'";
}else{
    $sql = "SELECT * FROM userevents WHERE user_id='$user_id' LIMIT 5";
}
...
//                                    ";
                ...
                echo "<div class='priceBtns'>
                        <button type='button' id='edit' class='btn btn-lg msgBtn btnColor eventBtn' data-toggle='modal' data-target='#editEventModal' data-event_id='$event_id'>Edit</button>
        ...
        echo "<div class='alert alert-warning'>You have not created any events yet!</div>";
    }
}
