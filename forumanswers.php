...
<html lang="en">
    <head>
        <title>Help Centre - Answers</title>
        <meta charset="UTF-8">
      ...
      <?php
        ...
        <div class="container-fluid breadcrumb-container">
                <ol class="breadcrumb breadcrumb-custom">
                    <li class="breadcrumb-item"><a href="forum.php">Categories</a></li>
                    <li class="breadcrumb-item"><a href="forumquestions.php?id=<?php echo $cat; ?>">Questions</a></li>
            ...
            if(isset($_SESSION["user_id"])){
                ...
                <p class='user-greeting'>
                    Hi, <a href='userdetails.php'><b>$username</b></a> Not you? <a href='./php/logout.php'>Login Here</a>
                </p>
                ";
            }
      ...
      <div class="container" id="forumContainer">
          ...
          <div class='row' id="forumHome">
              ...
              <div class="buttons col-xs-6">
                  <?php
                if($_SESSION['level'] == 9){
                    echo "<button type='button' id='deleteTop' class='btn btn-lg btnColor delete pull-right'>Delete Mode</button>";
                }
                ?>
              </div>
          </div>
          ...
          <div class='replyExpandable' id="replybarid">
            <div class="replybarcontent" data-js-expandable-inner>
                ...
                <form class='form form-inline' method='post' id='replyForm'>
                    ...
                    echo "
                <div class='alert alert-info'>Please sign in to reply to this question!</div>
                    ";
                }
                ?>
...
<!--      Here Maps API Java-->
      ...
      <script src="js/forumposts.js"></script>
