...
<!--      Custom Styling-->
    ...
    <title>thelittledarkone - Shop</title>
  </head>
  <body>
<!--    Header-->
      <div class="jumbotron">
        <div class="container headerContainer">
            <img src="css/images/kisspng-dragonvale-symbol-dragon-5ad22b28c84534.6640012915237230488203.png" class="logo">
            <h1>T.L.D.O. Adventures</h1>  
        </div>
      </div>
<!--    Nav Bar-->
      <?php
      ...
      <div class="container" id="shopContainer">
          <form class="refineForm" id="dtForm">
              <label for="refine" id="refineLabel">Refine:</label>
            <select name="refine" id="refine" class="refine">
                <option value="a" <?php 
                            if(!isset($_SESSION["refine"]) || $_SESSION["refine"] == 'a'){
                                echo "selected";
                            }
                        ?>>All</option>
                <option value="f" <?php 
                            if($_SESSION["refine"] == 'f'){
                                echo "selected";
                            }
                        ?>>Free</option>
                <option value="c" <?php 
                            if($_SESSION["refine"] == 'c'){
                                echo "selected";
                            }
                        ?>>Class Option</option>
                <option value="g" <?php 
                            if($_SESSION["refine"] == 'g'){
                                echo "selected";
                            }
                        ?>>Game Mechanic</option>
                <option value="v" <?php 
                            if($_SESSION["refine"] == 'v'){
                                echo "selected";
                            }
                        ?>>Adventure</option>
                <option value="x" <?php 
                            if($_SESSION["refine"] == 'x'){
                                echo "selected";
                            }
                        ?>>Campaign</option>
                <option value="m" <?php 
                            if($_SESSION["refine"] == 'm'){
                                echo "selected";
                            }
                        ?>>Monster Type</option>
                <option value="w" <?php 
                            if($_SESSION["refine"] == 'w'){
                                echo "selected";
                            }
                        ?>>World Building</option>
                <option value="z" <?php 
                            if($_SESSION["refine"] == 'z'){
                                echo "selected";
                            }
                        ?>>Compendium</option>
            </select>
            ...
            <select name="sortby" id="sortby" class="sortby">
                ...
                <option value="c" <?php 
                        ...
                        ?>>Price: Largest</option>
                <option value="r" <?php 
                            if(!isset($_SESSION["sort"]) || $_SESSION["sort"] == 'r'){
                                echo "selected";
                            }
                        ?>>Release: Latest</option>
                <option value="l" <?php 
                            if($_SESSION["sort"] == 'l'){
                                echo "selected";
                            }
                        ?>>Release: Oldest</option>                
            </select>
            <button class="btn btn-sm btnColor refineBtn" id="refineBtn" type="button">&#x1F50E;&#xFE0E;</button>
        </form>
          <form class="refineForm" id="phoneForm">
              <label for="refineP" id="refineLabel">Refine:</label>
            <select name="refineP" id="refineP" class="refine">
                <option value="a" <?php 
                            if(!isset($_SESSION["refine"]) || $_SESSION["refine"] == 'a'){
                                echo "selected";
                            }
              ...
              <label for="sortbyP" id="sortbyLabel">Sort By:</label>
            <select name="sortbyP" id="sortbyP" class="sortby">
                <option value="p" <?php 
                            if($_SESSION["sort"] == 'p'){
                                echo "selected";
                            }
            ...
            <button class="btn btn-sm btnColor refineBtn" id="refineBtnP" type="button">&#x1F50E;&#xFE0E;</button>
        </form>
          <div id="alert" class="alert alert-danger collapse">
                <a class="close" data-dismiss="alert">&times;</a>
                <p id="alertContent"></p>
          </div>
          <div row text-center id="products">
