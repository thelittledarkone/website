...
$sql = "SELECT * FROM userevents WHERE (player1_id='$profile_id' OR player2_id='$profile_id' OR player3_id='$profile_id' OR player4_id='$profile_id' OR player5_id='$profile_id' OR player6_id='$profile_id' OR player7_id='$profile_id' OR player8_id='$profile_id') AND regular='N' AND (date < now()) ORDER BY date ASC LIMIT 2";
